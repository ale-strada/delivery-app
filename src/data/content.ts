...
export const brand = {
  ...
  whatsapp: "5493511234567", // fake — reemplazar por el número real
};
...
export const stats = [
  { value: "+1M", label: "personas trabajan en apps de delivery y transporte en Argentina" },
  { value: "60%", label: "de quienes piden una moto de trabajo no califica para un crédito bancario" },
  { value: "2,5×", label: "más entregas estimadas por día al pasar de bici a moto propia" },
];
